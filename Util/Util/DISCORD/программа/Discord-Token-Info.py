...
try:
    ...
    Slow(f"""
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
 {INFO_ADD} Status       : {white}{status}{purple}
 {INFO_ADD} Token        : {white}{token_discord}{purple}
 {INFO_ADD} Username     : {white}{username_discord}{purple}
 {INFO_ADD} Display Name : {white}{display_name_discord}{purple}
 {INFO_ADD} Id           : {white}{user_id_discord}{purple}
 {INFO_ADD} Created      : {white}{created_at_discord}{purple}
 {INFO_ADD} Country      : {white}{country_discord}{purple}
 {INFO_ADD} Email        : {white}{email_discord}{purple}
 {INFO_ADD} Verified     : {white}{email_verified_discord}{purple}
 {INFO_ADD} Phone        : {white}{phone_discord}{purple}
 {INFO_ADD} Nitro        : {white}{nitro_discord}{purple}
 {INFO_ADD} Linked Users : {white}{linked_users_discord}{purple}
 {INFO_ADD} Avatar Decor : {white}{avatar_decoration_discord}{purple}
 {INFO_ADD} Avatar       : {white}{avatar_discord}{purple}
 {INFO_ADD} Avatar URL   : {white}{avatar_url_discord}{purple}
 {INFO_ADD} Accent Color : {white}{accent_color_discord}{purple}
 {INFO_ADD} Banner       : {white}{banner_discord}{purple}
 {INFO_ADD} Banner Color : {white}{banner_color_discord}{purple}
 {INFO_ADD} Flags        : {white}{flags_discord}{purple}
 {INFO_ADD} Public Flags : {white}{public_flags_discord}{purple}
 {INFO_ADD} NSFW         : {white}{nsfw_discord}{purple}
 {INFO_ADD} Multi-Factor Authentication : {white}{mfa_discord}{purple}
 {INFO_ADD} Authenticator Type          : {white}{authenticator_types_discord}{purple}
 {INFO_ADD} Billing      : {white}{payment_methods_discord}{purple}
 {INFO_ADD} Gift Code    : {white}{gift_codes_discord}{purple}
 {INFO_ADD} Guilds       : {white}{guild_count}{purple}
 {INFO_ADD} Owner Guilds : {white}{owner_guild_count}{owner_guilds_names}{purple}
 {INFO_ADD} Bio          : {white}{bio_discord}{purple}
 {INFO_ADD} Friend       : {white}{friends_discord}{purple}
{white}────────────────────────────────────────────────────────────────────────────────────────────────────────────────────────
    """)
    Continue()
    Reset()
