    ...
    def token_check():
        ...
        try:
            try:
                ...
                print(f"{BEFORE + current_time_hour() + AFTER} {GEN_INVALID} Status: {white}Invalid{purple} Token: {white}{token}{purple}")
        except:
            print(f"{BEFORE + current_time_hour() + AFTER} {GEN_INVALID} Status: {white}Error{purple} Token: {white}{token}{purple}")
