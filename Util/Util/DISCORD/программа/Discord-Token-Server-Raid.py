...
try:
    ...
    def raid(tokens, channels, message):
        try:
            ...
            print(f"{BEFORE + current_time_hour() + AFTER} {GEN_INVALID} Message: {white}{message_sensur}{purple} Channel: {white}{channel}{purple} Status: {white}Error {response.status_code}{purple}")
