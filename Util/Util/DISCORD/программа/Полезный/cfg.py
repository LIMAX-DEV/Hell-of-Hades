...
try:
    ...
    print(f'Modules of the python library required are not installed, make sure you have correctly installed python and have launched the "Setup.py" file which will install all the necessary modules.')
    input(f'Error: {e}')

color_webhook = 0x0000FF  # Changed to blue
