    ...
    def webhook_check():
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                print(f"{BEFORE + current_time_hour() + AFTER} {GEN_INVALID} Status: {white}Invalid{purple} Webhook: {white}{webhook_test_code}{purple}")
        except:
            print(f"{BEFORE + current_time_hour() + AFTER} {GEN_INVALID} Status: {white}Error{purple} Webhook: {white}{webhook_test_code}{purple}")
